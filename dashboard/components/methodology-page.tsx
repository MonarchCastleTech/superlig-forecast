    ...
    <main className="methodology-page">
      ...
      <article className="methodology-paper">
        ...
        <section id="production" className="production-disclosure">
          ...
          <p><strong>The published homepage is generated by the method described on this page.</strong> It reads <code>dashboard.json</code>, produced by the Python <code>forecast-season</code> command. This is a disclosure of the current implementation, not a description of a planned model.</p>
          <table>
          ...
          <aside><strong>Current information cutoff.</strong> Match snapshot: {formatForecastUpdate(data.freshness.match_snapshot_at)}. Squad/value snapshot: {formatForecastUpdate(data.freshness.valuation_snapshot_at)}. Model artifact: {data.meta.model_version}; seed: {data.meta.seed}. These fields come from the same payload displayed by the homepage.</aside></div>
        </section>
